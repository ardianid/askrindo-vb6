...
Begin VB.Form frm_lap_sisa_pensiun 
   ClientHeight    =   5520
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   6660
   ...
   Begin IsButton_Ard.isButton isButton1 
      ...
      _ExtentX        =   873
      _ExtentY        =   741
      Icon            =   "frm_lap_sisa_pensiun.frx":0000
      Style           =   8
      Caption         =   "x"
      iNonThemeStyle  =   0
      Tooltiptitle    =   ""
   ...
   End
End
Attribute VB_Name = "frm_lap_sisa_pensiun"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As r_sisapensiun
